/* geklaut von hier: https://github.com/thlorenz/sql-escape-string/blob/master/sql-escape-string.js*/
...
export function escapeString(val: string, opts?: any):string {
    ...
    const charsEscapeMap:any = CHARS_ESCAPE_BACKSLASH_SUPPORTED_MAP;
